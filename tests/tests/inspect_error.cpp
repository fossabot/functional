...
// clang-format off
static_assert(invocable_inspect_error<decltype(fn_Error<void>), fn::expected<int, Error>>);
static_assert(invocable_inspect_error<decltype(fn_generic<void>), fn::expected<void, Error>>);
static_assert(invocable_inspect_error<decltype(fn_int<void>), fn::expected<void, int>>);
static_assert(not invocable_inspect_error<decltype(fn_int<int>), fn::expected<void, int>>); // wrong return type
static_assert(not invocable_inspect_error<decltype(fn_int<void>), fn::expected<void, Error>>); // wrong parameter type
static_assert(invocable_inspect_error<decltype(fn_Error<void>), fn::expected<void, Xerror>>); // parameter type conversion
static_assert(invocable_inspect_error<decltype(fn_generic<void>), fn::expected<Value, Error>>);
static_assert(not invocable_inspect_error<decltype(fn_int<void>), fn::expected<Value, Error>>); // wrong parameter type

static_assert(invocable_inspect_error<decltype(fn_generic<void>), fn::optional<int>>);
static_assert(not invocable_inspect_error<decltype(fn_generic<int>), fn::optional<Value>>); // wrong return type

// binding to const lvalue-ref
static_assert(invocable_inspect_error<decltype(fn_int_const_lvalue), fn::expected<void, int>>);
static_assert(invocable_inspect_error<decltype(fn_int_const_lvalue), fn::expected<void, int> const>);
static_assert(invocable_inspect_error<decltype(fn_int_const_lvalue), fn::expected<void, int> &>);
static_assert(invocable_inspect_error<decltype(fn_int_const_lvalue), fn::expected<void, int> const &>);
static_assert(invocable_inspect_error<decltype(fn_int_const_lvalue), fn::expected<void, int> &&>);
static_assert(invocable_inspect_error<decltype(fn_int_const_lvalue), fn::expected<void, int> const &&>);
...
static_assert(not invocable_inspect_error<decltype(fn_int_lvalue), fn::expected<void, int>>);
// cannot bind lvalue to const rvalue-ref
static_assert(not invocable_inspect_error<decltype(fn_int_const_rvalue), fn::expected<void, int>>);
// cannot bind lvalue to rvalue-ref
static_assert(not invocable_inspect_error<decltype(fn_int_rvalue), fn::expected<void, int>>);
