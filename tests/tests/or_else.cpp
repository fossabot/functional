...
// clang-format off
static_assert(invocable_or_else<decltype(fn_Error<expected<Value, Error>>), fn::expected<Value, Error>>);
static_assert(invocable_or_else<decltype(fn_generic<expected<int, int>>), fn::expected<int, int>>);
static_assert(invocable_or_else<decltype(fn_Error<expected<Value, Xerror>>), fn::expected<Value, Error>>); // error type conversion
static_assert(invocable_or_else<decltype(fn_Error<expected<Value, Error>>), fn::expected<Value, Xerror>>); // error type conversion
static_assert(invocable_or_else<decltype(fn_Error<expected<Value, int>>), fn::expected<Value, Xerror>>); // error type conversion
static_assert(not invocable_or_else<decltype(fn_Error<expected<Value, int>>), fn::expected<Value, int>>); // wrong error_type
static_assert(invocable_or_else<decltype(fn_Error<expected<Value, Error>>), fn::expected<Value, Error>>);
static_assert(not invocable_or_else<decltype(fn_Error<expected<Value, Error>>), fn::expected<void, Error>>); // cannot change value_type
static_assert(not invocable_or_else<decltype(fn_Error<expected<void, Error>>), fn::expected<Value, Error>>); // cannot change value_type
static_assert(not invocable_or_else<decltype(fn_generic<expected<Value, int>>), fn::expected<int, int>>); // cannot change value_type

static_assert(not invocable_or_else<decltype(fn_generic<expected<Value, Error>>), fn::optional<Value>>); // mixed optional and expected
static_assert(not invocable_or_else<decltype(fn_generic<optional<Value>>), fn::expected<Value, Error>>); // mixed optional and expected
static_assert(invocable_or_else<decltype(fn_generic<optional<Value>>), fn::optional<Value>>);
static_assert(not invocable_or_else<decltype(fn_generic<optional<int>>), fn::optional<Value>>); // cannot change value_type
static_assert(not invocable_or_else<decltype(fn_generic<optional<Value>>), fn::optional<int>>); // cannot change value_type

static_assert(not invocable_or_else<decltype(fn_int_lvalue<expected<int, int>>), fn::expected<int, int>>); // cannot bind temporary to lvalue
static_assert(invocable_or_else<decltype(fn_int_lvalue<expected<int, int>>), fn::expected<int, int> &>);
static_assert(invocable_or_else<decltype(fn_int_rvalue<expected<int, int>>), fn::expected<int, int>>);
static_assert(not invocable_or_else<decltype(fn_int_rvalue<expected<int, int>>), fn::expected<int, int> &>); // cannot bind lvalue to rvalue-ref
// clang-format on
} // namespace fn
